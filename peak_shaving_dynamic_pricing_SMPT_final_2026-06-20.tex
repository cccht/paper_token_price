...
\caption{Profit components and pure-strategy regret boundary. The left panel decomposes profit by market participant, and the right panel reports stored best-response regret. The coarse snapshot reaches regret $<5$, whereas the fine-grid pure snapshot remains at $22.3$ and is used only as a resolution stress test.}
