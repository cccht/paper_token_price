...
A public project repository containing the current manuscript, code, figure scripts, and generated artifacts is available at \url{https://github.com/cccht/paper_token_price}. For formal submission, the repository should be frozen as a versioned release or archival digital object identifier containing the final manuscript, code, configuration files, raw JSON/CSV artifacts, figure scripts, and generated figures. Until that archival release is created, the GitHub repository should be treated as a living reproducibility package rather than a persistent data identifier.
